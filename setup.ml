...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0c9e8443d8f4f0400640be1ef42af099) *)
(*
...
let setup_t =
  {
       ...
       [
          ("lib",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("omake", ["check"]))];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Óø\011WKêÚÄ¦¨b¼\146/z\134";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
